...
$preco_produto = $_POST['precoP'];
$quant_produto = $_POST['quantP'];
$imagem_produto = $_POST['imagemP'];
// $des_produto = $_POST['descricaoP']; -> vai ser consertado em breve
    ...
    $sql = "INSERT INTO produtos (nome_produto, preco_produto, quant_produto, imagem_produtos,descricao_produto) VALUES ('$nome_produto', '$preco_produto', '$quant_produto', '$imagem_produto','-')";
